...
| 29 | **Four of the seven rooms have no usable photography at all.** Quantified 2026-08-05 during placement. College Heights has 24 frames and Crown Point 6, and those are the only two rooms that can show themselves. **Mercury** has exactly two room frames, at 612x284 and 1000x750, too small to place. **East Village's** single photograph is a plate of shishito peppers, not a room. **Plaza Bonita** and **Maui** have no room photography. **Convoy has 60 photographs and every one is food**, so the site's highest-traffic location page still pulls its storefront shot from `tajimaramen.com/wp-content/uploads/`, the WordPress site this project replaces. That link dies at migration and there is no replacement in the manifest. This is the concrete, costed version of `CLIENT_FACTS.md` open question #15, and the Convoy storefront is the single most urgent frame in it. | five location pages, and `/tajima-convoy/`'s hero at migration | Steve / Amanda |
